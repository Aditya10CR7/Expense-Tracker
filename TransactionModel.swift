...
//  ExpenseTracker
//
//  Created by Aditya Pandiarajan on 05/09/23.
//
...
extension Category {
    ...
    static let entertainment = Category(id: 3, name: "Enterntainment", icon: .film)
    ...
    static let transfer = Category(id: 9, name: "Transport", icon: .exchange_alt)
    
    static let publicTransportation = Category(id: 101, name: "Public Transportations", icon: .bus, mainCategoryId: 1)
